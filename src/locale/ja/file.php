...
return [
    ...
    'image_insert' => '画像挿入',
    'image_and_file_insert' => '画像（ファイル）挿入',
    'file_image_manage' => '画像/ファイル管理',
    ...
    'file_too_large_server' => 'ファイルサイズがサーバーで許可されたアップロード上限を超えています。',
    'file_upload_partial' => 'ファイルのアップロードが途中で中断されました。もう一度お試しください。',
    'file_type_not_allowed' => 'このファイル形式はアップロードできません。アップロードできる形式: :types。',
    'file_too_large' => 'ファイルサイズが上限の:sizeを超えています。',
